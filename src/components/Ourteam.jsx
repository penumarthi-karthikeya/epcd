import '../index.css'
// Component to render a single social media icon with SVG
const SocialIcon = ({ href, ariaLabel, svgPath, tooltipText,datasocial }) => (
    <li className="icon-content">
        <a href={href} aria-label={ariaLabel} target="_blank" rel="noopener noreferrer" data-social={datasocial}>
            <div className="filled"></div>
            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className={`bi ${ariaLabel}`} viewBox="0 0 16 16">
                <path d={svgPath}  loading='lazy'/>
            </svg>
        </a>
